...
int main(){
  ...
  int *p = &y;        // p was declared as a pointer to a memory address containing an integer also referred to variable y
  ...
  cout << a << " " << *a << endl; //The "a" will print the memory address of the first element of the array, the second "*a" will print the first element of the array
                                  ...
                                  // There is only one situation where the array do NOT decay into a pointer (first element). 
